...
type customizationsOnDisk struct {
	...
	DeprecatedContainersStorage *ContainerStorageCustomization `json:"containers-storage,omitempty" toml:"containers-storage,omitempty"`
	ContainersStorage           *ContainerStorageCustomization `json:"containers_storage,omitempty" toml:"containers_storage,omitempty"`
...
func bpCustomizationsFromOD(cod *customizationsOnDisk) (*Customizations, error) {
	...
	case cod.DeprecatedContainersStorage != nil:
		cus.ContainersStorage = cod.DeprecatedContainersStorage
	case cod.ContainersStorage != nil:
		cus.ContainersStorage = cod.ContainersStorage
	}
