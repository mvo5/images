...
func TestNewBuildFromContainerSpecs(t *testing.T) {
	...
	require.Nil(t, err)
	require.Contains(t, string(json), `{"name":"build","runner":"org.osbuild.fedora39","stages":[{"type":"org.osbuild.container-deploy","inputs":{"images":{"type":"org.osbuild.containers","origin":"org.osbuild.source","references":{"sha256:511295a6eabcf0ca042017ed9e6561e4facd687b05910c0df56e4b11f4fb24b2":{"name":"ghcr.io/ondrejbudai/bootc:centos"}`)
