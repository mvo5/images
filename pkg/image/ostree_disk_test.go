...
func TestOSTreeDiskImageManifestSetsContainerBuildable(t *testing.T) {
	...
	restore := image.MockManifestNewBuild(func(m *manifest.Manifest, r runner.Runner, repos *inputs.RepoContainerConfig, opts *manifest.BuildOptions) manifest.Build {
