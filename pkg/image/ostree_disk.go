...
func baseRawOstreeImage(img *OSTreeDiskImage, buildPipeline manifest.Build, useBootupd bool) *manifest.RawOSTreeImage {
	...
	osPipeline.UseBootupd = useBootupd
...
func (img *OSTreeDiskImage) InstantiateManifest(m *manifest.Manifest,
	...
	// XXX: use opt{} here instead of boolean
	baseImage := baseRawOstreeImage(img, buildPipeline, false)
